    ...
    <div class="row justify-content-center">
        <div class="container margin_60_35">
            ...
            <div class="text-center">
                <h3>My wallet: <span class="text-success"> {{ Auth::user()->portefeuille }}</span> </h3>
            </div>
            <br>
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="grid_item">
                            <figure>
                                ...
                                <a style="width: 80%; height:80%" href="{{ route('nfts.show', ['id' => $nft->id]) }}">
                                    <img class="img-fluid lazy" style="width: 80%; height:80%" src="{{ asset('ecommerce/img/products/product_placeholder_square_medium.jpg') }}" data-src="{{ $nft->image }}" alt="">
